...
"""
This script is used as a first step to build val annotations for pre-training
...
def convert(split, data_path, sg_path, output_path, imid2data):
...
def main(args):
    ...
    convert("val", data_path, sg_path, output_path, imid2data)
